...
4. **Duplicate Code**
   ...
   Duplicating code always ends with a mess. If you fixed a bug somewhere you need to re-patch it multiple times. Having less and non-redundant code saves time as well as increases maintainability.
   
   > Every piece of knowledge or logic must have a single, unambiguous representation within a system.[^1]
