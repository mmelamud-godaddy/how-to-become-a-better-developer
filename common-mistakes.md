...
It's wrong to assume that developers job is to write code and someone elses job to tell developers what code to write. Business cannot simply tell you what the sollution is so developers can translate that into code.
